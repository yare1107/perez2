...
global.owner = [
   ['5219162788919', 'perez 👑', true],
   ['573132641948', 'sxnt 👑', true],
]
...
global.APIKeys = {
  'https://api.fgmods.xyz': 'm2XBbNvz' //-- 100 de límite diario
}
...
global.namebot = 'AmeriBot'
global.sessions = 'SiskedSession'
global.jadi = 'SiskedJadiBot'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packname = 'AMERI BOT'
global.botname = 'AMERI BOT'
global.wm = '𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐁𝐎𝐓'
global.author = 'Sxnt - Good 🍁'
global.dev = '𝙉𝙤𝙩 𝙈𝙮 𝙋𝙧𝙤𝙡𝙚𝙢𝙖'
global.textbot = 'AMERI BOT'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.catalogo = fs.readFileSync('./src/img/catalogo.png')
global.sxnturl = fs.readFileSync('./src/img/sxnturl.jpg')
global.avatar = fs.readFileSync('./src/img/avatar_contact.png')

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.grupo = 'https://chat.whatsapp.com/L481VM9rJ2JJj5y3atndy8'
global.channel = ''
global.channel2 = ''
global.md = 'https://wa.me/qr/OEGLZUMXONHDL1' 
global.ig = 'https://www.instagram.com/08._santiago17'
global.tiktok = 'https://www.tiktok.com/@sxnt.xit'
